...
export default function ClientLayout({
  ...
  // Items del menú de navegación (dinámico según rol del usuario)
  const getAllMenuItems = () => {
    ...
    // Agregar "Administración" solo para AdminCOP
    if (currentUser?.role === 'AdminCOP') {
      baseMenuItems.push({
        name: 'Administración',
        href: '/administracion',
        icon: (
  ...
  // Obtener los items del menú según el rol del usuario actual
